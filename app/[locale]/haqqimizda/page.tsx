...
export default function AboutPage() {
  ...
  if (!about) {
    return (
      <main className="mx-auto max-w-7xl px-4 py-20">
        <h1 className="text-3xl font-extrabold text-black">{t("about.badge")}</h1>
        <p className="mt-3 text-black/70">{t("about.noData")}</p>
      </main>
    );
  }
  ...
  const highlights = [
    { title: t("about.experienceTrust"), desc: paragraphs[0] || "", Icon: FiAward },
    { title: t("about.workshopsProduction"), desc: paragraphs[1] || "", Icon: FiTool },
    { title: t("about.guarantee"), desc: paragraphs[2] || "", Icon: FiShield },
    { title: t("about.oneSolution"), desc: paragraphs[3] || "", Icon: FiLayers },
  ];

  const stats = [
    { k: "25+", v: t("about.experience"), Icon: FiCheckCircle },
    { k: "3", v: t("about.workshops"), Icon: FiTool },
    { k: "700+", v: t("about.orders"), Icon: FiUsers },
    { k: "1", v: t("about.oneAddress"), Icon: FiMapPin },
  ];
    ...
    <main className="bg-white">
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-12">
            <div className="lg:col-span-7">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                ...
                >
                  {t("about.contactBtn")} <FiArrowRight className="h-4 w-4" />
                </Link>
              ...
              <div className="rounded-3xl border border-black/10 bg-white p-7 shadow-[0_15px_40px_rgba(0,0,0,0.08)]">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-semibold text-black">{t("about.companyProfile")}</div>
      ...
      <section className="py-14 md:py-18">
        <div className="mx-auto max-w-7xl px-4">
          <div>
            <h2 className="text-3xl font-extrabold text-black">{t("about.whyUs")}</h2>
          ...
          <div className="mx-auto max-w-7xl px-4">
            <div>
              <h2 className="text-3xl font-extrabold text-black">
                {cleanText(partnersSection?.title) || t("about.partners")}
              </h2>
              <div className="mt-3 h-1 w-14 bg-[#F2A900]" />
            </div>
